...
export default function SettingsModal({ changeModalVisible, visible, title, navigation, route }) {
				...
				<ThemeCard
					...
					onPress={() => {
						if (
							...
							route.params.player_id === undefined ||
							route.params.player_name === undefined
						) {
