...
export default function RegisterModal({ changeModalVisible, visible, navigation, title }) {
	...
	return (
		<CustomModal visible={visible} title={title} changeModalVisible={changeModalVisible}>
			...
			<Text
				...
				onPress={() => {
					Alert.alert("Privacy Policy and GDPR Consent", privacyPolicy.privacyPolicy)
				}}>
