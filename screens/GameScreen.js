...
import { addScore } from "../core/apiRequests"
import {
			...
			if (swapTwoItemsOnGrid(grid, firstPress, lastPress) != false) {
				...
				if (matches.length > 0) {
					...
					if (getAllHints(grid).length === 0) {
						console.log(
							"No more matches on the grid, regenerating grid in order to continue game"
						)
			...
			<SafeAreaView style={styles.safeArea}>
				...
				<View style={styles.centerContainer}>
					...
					<Toast
						...
						warning="No matches found on the grid."></Toast>
				...
				<View style={styles.bottomContainer}>
					...
					<IconButton iconName="exit-to-app" title="Quit game" press={quitGame} />
